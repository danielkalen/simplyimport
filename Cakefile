...
chalk = require 'chalk'
Path = require 'path'
testModules = ['mocha', 'chai', 'browserify', 'babelify', 'babel-preset-es2015-script', 'envify', 'icsify', 'axios', 'moment', 'timeunits', 'yo-yo', 'smart-extend', 'p-wait-for', 'source-map-support', 'xmlhttprequest', 'location', ['traceur', ()-> parseFloat(process.version.slice(1)) < 6.2]]
