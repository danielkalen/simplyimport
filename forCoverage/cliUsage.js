...
var chalk, labels, orLabel, values;
...
values = {
  ...
  'importExamples': ["import 'parts/someFile.js'", "import 'parts/someFile.coffee'", "import parts/someFile", "import * as customExports from ../../parts/someFile", "import {readFile, readdir as readDir} from 'fs'", "import [conditionA, conditionB] parts/someFile.js", "var foo = import parts/someLibrary.js", "require('../parts/someFile')"].map(function(str) {
  ...
  'exportExamples': ["export var abc = '123'", "export default function(){}", "export function fnName = ()=> 123", "export {aaa, bbb as BBB, ccc}", "exports = {'aaa':aaa, 'BBB':bbb}", "module.exports['ddd'] = 'ddd'", "module.exports.eee = 'eee'"].map(function(str) {
    return chalk.dim(str);
  }).join('\n      ')
};

module.exports = [labels.usage + " " + values.usage, labels.importDirective + " " + values.importDirective, labels.importExamples + "\n      " + values.importExamples + "\n", labels.exportDirective + " " + values.exportDirective, labels.exportExamples + "\n      " + values.exportExamples].join('\n');
