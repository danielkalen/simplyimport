...
exec('node '+__dirname+'/../../bin/simplyimport -i '+__dirname+'/_importer.js -s', function(error, stdout, stderror){
	...
	if (!stdout.match(/\@import 'nonexistent\.js'/)) {console.log('Imported non-existent file or there was an error relating to it.\x1b[0m'); passedTests = false;}

	if (passedTests) {
		console.log('Standard Import - \x1b[32mPassed All Tests\x1b[0m');
	}
});