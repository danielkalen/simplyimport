		...
		test "mixed", ()->
			Promise.resolve()
				...
				.then ({compiled, result, writeToDisc})->
					...
					assert.deepEqual origPos(13,0),		line(1,0,'mixed.js')
					assert.deepEqual origPos(13,12),	line(1,12,'mixed.js')
					assert.deepEqual origPos(14,0),		line(2,0,'mixed.js')
					assert.deepEqual origPos(14,12),	line(2,12,'mixed.js')
					assert.deepEqual origPos(14,17),	line(2,12,'mixed.js')
					assert.deepEqual origPos(18,4),		line(3,0,'mixed.js')
					assert.deepEqual origPos(23,0),		line(4,0,'mixed.js')
					assert.deepEqual origPos(23,12),	line(1,0,'d.js')
					assert.deepEqual origPos(25,0),		line(5,0,'mixed.js')
					assert.deepEqual origPos(25,8),		line(5,8,'mixed.js')
					assert.deepEqual origPos(25,8),		line(5,8,'mixed.js')
					assert.deepEqual origPos(26,0),		line(6,0,'mixed.js')
					assert.deepEqual origPos(26,18),	line(1,0,'package.json')
					assert.deepEqual origPos(27,0),		line(7,0,'mixed.js')
					assert.deepEqual origPos(28,0),		line(8,0,'mixed.js')
					assert.deepEqual origPos(28,12),	line(1,0,'node_modules/module-f/index.js')
					assert.deepEqual origPos(30,0),		line(9,0,'mixed.js')
					assert.deepEqual origPos(34,0),		line(1,0,'a.js')
					assert.deepEqual origPos(38,0),		line(1,0,'b.js')
					assert.deepEqual origPos(38,18),	line(1,15,'b.js')
					assert.deepEqual origPos(43,0),		line(1,0,'node_modules/module-e/_index.coffee')
					assert.deepEqual origPos(43,31),	line(2,0,'node_modules/module-e/_index.coffee')
					assert.deepEqual origPos(43,38),	line(2,5,'node_modules/module-e/_index.coffee')
					assert.deepEqual origPos(52,5),		line(1,48,'node_modules/module-g/index.coffee')
					assert.deepEqual origPos(56,6),		line(1,56,'node_modules/module-g/index.coffee')
		...
		test "force inlines", ()->
			Promise.resolve()
				...
				.then ({compiled, result, writeToDisc})->
					...
					assert.deepEqual origPos(13,0),		line(1,0,'inlines.js')
					assert.deepEqual origPos(13,12),	line(1,12,'inlines.js')
					assert.deepEqual origPos(14,0),		line(2,0,'inlines.js')
					...
					assert.deepEqual origPos(17,0),		line(3,0,'inlines.js')
					assert.deepEqual origPos(17,12),	line(3,12,'inlines.js')
					assert.deepEqual origPos(18,0),		line(4,0,'inlines.js')
					assert.deepEqual origPos(18,12),	line(1,0,'d.js')
					assert.deepEqual origPos(18,18),	line(1,5,'d.js')
					assert.deepEqual origPos(18,24),	line(2,0,'d.js')
					assert.deepEqual origPos(19,0),		line(5,0,'inlines.js')
					assert.deepEqual origPos(19,12),	line(5,12,'inlines.js')
					assert.deepEqual origPos(20,0),		line(6,0,'inlines.js')
					assert.deepEqual origPos(20,18),	line(1,0,'package.json')
					assert.deepEqual origPos(21,0),		line(7,0,'inlines.js')
					assert.deepEqual origPos(21,12),	line(1,0,'node_modules/module-f/index.js')
					assert.deepEqual origPos(23,0),		line(8,0,'inlines.js')
					assert.deepEqual origPos(23,8),		line(8,8,'inlines.js')
					assert.deepEqual origPos(23,12),	line(8,12,'inlines.js')
		...
		test "conditionals", ()->
			Promise.resolve()
				...
				.then ({compiled, result, writeToDisc})->
					...
					assert.deepEqual origPos(13,0),		line(1,0,'conditionals.js')
					assert.deepEqual origPos(13,12),	line(1,12,'conditionals.js')
					assert.deepEqual origPos(14,0),		line(2,0,'conditionals.js')
					assert.deepEqual origPos(14,12),	line(1,0,'b.js')
					assert.deepEqual origPos(14,22),	line(1,9,'b.js')
					assert.deepEqual origPos(15,7),		line(2,8,'b.js')
					assert.deepEqual origPos(17,0),		line(3,0,'conditionals.js')
					assert.deepEqual origPos(17,12),	line(3,12,'conditionals.js')
					assert.deepEqual origPos(18,0),		line(4,0,'conditionals.js')
					assert.deepEqual origPos(18,12),	line(1,0,'d.js')
					assert.deepEqual origPos(18,18),	line(1,5,'d.js')
					assert.deepEqual origPos(18,24),	line(2,0,'d.js')
					assert.deepEqual origPos(19,0),		line(5,0,'conditionals.js')
					assert.deepEqual origPos(19,12),	line(5,12,'conditionals.js')
					assert.deepEqual origPos(20,0),		line(6,0,'conditionals.js')
					assert.deepEqual origPos(20,18),	line(1,0,'package.json')
					assert.deepEqual origPos(21,0),		line(7,0,'conditionals.js')
					assert.deepEqual origPos(21,8),		line(7,8,'conditionals.js')
					assert.deepEqual origPos(21,12),	line(7,12,'conditionals.js')
		...
		test "mods", ()->
			Promise.resolve()
				...
				.then ({compiled, result, writeToDisc})->
					...
					assert.deepEqual origPos(14,0),		line(1,0,'mods.js')
					assert.deepEqual origPos(14,12),	line(1,12,'mods.js')
					assert.deepEqual origPos(15,0),		line(2,0,'mods.js')
					assert.deepEqual origPos(16,0),		line(3,0,'mods.js')
					assert.deepEqual origPos(16,12),	line(1,0,'b.js')
					assert.deepEqual origPos(16,22),	line(1,9,'b.js')
					assert.deepEqual origPos(17,7),		line(2,8,'b.js')
					assert.deepEqual origPos(19,0),		line(4,0,'mods.js')
					assert.deepEqual origPos(19,12),	line(4,12,'mods.js')
					assert.deepEqual origPos(20,0),		line(5,0,'mods.js')
					assert.deepEqual origPos(21,0),		line(6,0,'mods.js')
					
					assert.deepEqual origPos(188,0),	line(1,0,'c.js')
					assert.deepEqual origPos(189,7),	line(2,7,'c.js')
